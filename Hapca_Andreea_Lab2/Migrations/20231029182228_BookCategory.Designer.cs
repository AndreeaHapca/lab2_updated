...
namespace Hapca_Andreea_Lab2.Migrations
{
    ...
    [Migration("20231029182228_BookCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HapcaAndreea_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HapcaAndreea_Lab2.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HapcaAndreea_Lab2.Models.BookCategory", b =>
                {
                    b.HasOne("Hapca_Andreea_Lab2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HapcaAndreea_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
